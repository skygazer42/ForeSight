# Global ML Step-Lag Phase 4 Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add three more scikit-learn global/panel forecasting models on top of the existing step-lag pipeline: `kernel-ridge-step-lag-global`, `svr-step-lag-global`, and `linear-svr-step-lag-global`.

# Global ML Step-Lag Phase 6 Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Finish the remaining scikit-learn global/panel forecasting models in the step-lag family: `adaboost-step-lag-global` and `mlp-step-lag-global`.
...
Add a short README mention and an `Unreleased` changelog note for the two new global scikit-learn models.

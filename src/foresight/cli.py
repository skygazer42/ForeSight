...
def _root_shortcut_handler(args: argparse.Namespace) -> Any:
    ...
    if wants_models:
        ...
        return lambda _args: _cmd_models_list(shortcut_args)
    ...
    if wants_datasets:
        ...
        return lambda _args: _cmd_datasets_list(shortcut_args)
...
def _cmd_data_infer_freq(args: argparse.Namespace) -> int:
    ...
    rows: list[dict[str, Any]] = []
    for unique_id, g in df2.groupby("unique_id", sort=True):
        ds = g[time_col]

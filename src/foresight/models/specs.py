...
def _base_model_capabilities(
    *,
    interface: str,
    param_help: dict[str, str],
) -> dict[str, Any]:
    interface_s = str(interface).strip().lower()
    supports_x_cols = "x_cols" in param_help
    supports_static_cols = "static_cols" in param_help
    supports_quantiles = "quantiles" in param_help
...
class ModelSpec:
    ...
    def capabilities(self) -> dict[str, Any]:
        capabilities = _base_model_capabilities(
            interface=self.interface,
            param_help=self.param_help,
        )

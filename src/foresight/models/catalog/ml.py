...
def build_ml_catalog(context: Any) -> dict[str, Any]:
    ...
    passive_aggressive_step_lag_global_forecaster = (
        context.passive_aggressive_step_lag_global_forecaster
    )
    ...
    CATBOOST_LOSS_PARAM_HELP = "Loss function (e.g. RMSE, MAE, Quantile:alpha=0.5, Poisson, ...)"
    ...
    ALLOW_WRITING_FILES_PARAM_HELP = "Allow writing files (false to avoid catboost_info output)"
    ...
    MIN_CHILD_SUM_WEIGHT_PARAM_HELP = "Minimum sum of instance weight needed in a child (>=0)"

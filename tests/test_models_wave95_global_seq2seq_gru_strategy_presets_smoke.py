...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-seq2seq-gru-ema-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-gru-swa-global", {"swa_start_epoch": 0}),
        ("torch-seq2seq-gru-sam-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-gru-regularized-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-gru-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-gru-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave95_global_seq2seq_gru_strategy_presets_smoke(

...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-dilated-rnn-ema-global", {"warmup_epochs": 1}),
        ("torch-dilated-rnn-swa-global", {"swa_start_epoch": 0}),
        ("torch-dilated-rnn-sam-global", {"warmup_epochs": 1}),
        ("torch-dilated-rnn-regularized-global", {"warmup_epochs": 1}),
        ("torch-dilated-rnn-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-dilated-rnn-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave67_global_dilated_rnn_strategy_presets_smoke(

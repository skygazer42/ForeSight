...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-gmlp-ema-global", {"warmup_epochs": 1}),
        ("torch-gmlp-swa-global", {"swa_start_epoch": 0}),
        ("torch-gmlp-sam-global", {"warmup_epochs": 1}),
        ("torch-gmlp-regularized-global", {"warmup_epochs": 1}),
        ("torch-gmlp-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-gmlp-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave62_global_gmlp_strategy_presets_smoke(key: str, overrides: dict[str, int]) -> None:

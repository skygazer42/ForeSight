...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-mamba-ema-global", {"warmup_epochs": 1}),
        ("torch-mamba-swa-global", {"swa_start_epoch": 0}),
        ("torch-mamba-sam-global", {"warmup_epochs": 1}),
        ("torch-mamba-regularized-global", {"warmup_epochs": 1}),
        ("torch-mamba-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-mamba-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave64_global_mamba_strategy_presets_smoke(key: str, overrides: dict[str, int]) -> None:

...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-transformer-encdec-ema-global", {"warmup_epochs": 1}),
        ("torch-transformer-encdec-swa-global", {"swa_start_epoch": 0}),
        ("torch-transformer-encdec-sam-global", {"warmup_epochs": 1}),
        ("torch-transformer-encdec-regularized-global", {"warmup_epochs": 1}),
        ("torch-transformer-encdec-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-transformer-encdec-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave56_global_transformer_encdec_strategy_presets_smoke(

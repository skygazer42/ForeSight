...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-seq2seq-attn-lstm-ema-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-attn-lstm-swa-global", {"swa_start_epoch": 0}),
        ("torch-seq2seq-attn-lstm-sam-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-attn-lstm-regularized-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-attn-lstm-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-attn-lstm-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave93_global_seq2seq_attn_lstm_strategy_presets_smoke(

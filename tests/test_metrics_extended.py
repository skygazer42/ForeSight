...
def test_mase_basic():
    ...
    assert mase(y_true, y_pred, y_train=y_train, seasonality=1) == pytest.approx(0.5)
...
def test_rmsse_basic():
    ...
    assert rmsse(y_true, y_pred, y_train=y_train, seasonality=1) == pytest.approx((0.5) ** 0.5)

...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("torch-seq2seq-lstm-swa-global", {"swa_start_epoch": 0}),
        ("torch-seq2seq-lstm-sam-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-lstm-regularized-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-lstm-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-lstm-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave94_global_seq2seq_lstm_strategy_presets_smoke(

...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-tcn-ema-global", {"warmup_epochs": 1}),
        ("torch-tcn-swa-global", {"swa_start_epoch": 0}),
        ("torch-tcn-sam-global", {"warmup_epochs": 1}),
        ("torch-tcn-regularized-global", {"warmup_epochs": 1}),
        ("torch-tcn-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-tcn-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave72_global_tcn_strategy_presets_smoke(key: str, overrides: dict[str, int]) -> None:

...
def test_wave83_global_nonstationary_transformer_strategy_presets_are_registered() -> None:
...
def test_wave83_global_nonstationary_transformer_strategy_preset_defaults() -> None:
    ema = get_model_spec("torch-nonstationary-transformer-ema-global")
    swa = get_model_spec("torch-nonstationary-transformer-swa-global")
    sam = get_model_spec("torch-nonstationary-transformer-sam-global")
    regularized = get_model_spec("torch-nonstationary-transformer-regularized-global")
    longhorizon = get_model_spec("torch-nonstationary-transformer-longhorizon-global")
    lookahead = get_model_spec("torch-nonstationary-transformer-lookahead-global")

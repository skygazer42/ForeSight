...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-seq2seq-attn-gru-ema-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-attn-gru-swa-global", {"swa_start_epoch": 0}),
        ("torch-seq2seq-attn-gru-sam-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-attn-gru-regularized-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-attn-gru-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-seq2seq-attn-gru-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave92_global_seq2seq_attn_gru_strategy_presets_smoke(

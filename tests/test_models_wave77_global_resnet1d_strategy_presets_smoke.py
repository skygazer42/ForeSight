...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-resnet1d-ema-global", {"warmup_epochs": 1}),
        ("torch-resnet1d-swa-global", {"swa_start_epoch": 0}),
        ("torch-resnet1d-sam-global", {"warmup_epochs": 1}),
        ("torch-resnet1d-regularized-global", {"warmup_epochs": 1}),
        ("torch-resnet1d-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-resnet1d-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave77_global_resnet1d_strategy_presets_smoke(key: str, overrides: dict[str, int]) -> None:

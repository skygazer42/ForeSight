...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-fnet-ema-global", {"warmup_epochs": 1}),
        ("torch-fnet-swa-global", {"swa_start_epoch": 0}),
        ("torch-fnet-sam-global", {"warmup_epochs": 1}),
        ("torch-fnet-regularized-global", {"warmup_epochs": 1}),
        ("torch-fnet-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-fnet-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave61_global_fnet_strategy_presets_smoke(key: str, overrides: dict[str, int]) -> None:

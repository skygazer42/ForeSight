...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-nonstationary-transformer-ema-global", {"warmup_epochs": 1}),
        ("torch-nonstationary-transformer-swa-global", {"swa_start_epoch": 0}),
        ("torch-nonstationary-transformer-sam-global", {"warmup_epochs": 1}),
        ("torch-nonstationary-transformer-regularized-global", {"warmup_epochs": 1}),
        ("torch-nonstationary-transformer-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-nonstationary-transformer-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave83_global_nonstationary_transformer_strategy_presets_smoke(

...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-etsformer-ema-global", {"warmup_epochs": 1}),
        ("torch-etsformer-swa-global", {"swa_start_epoch": 0}),
        ("torch-etsformer-sam-global", {"warmup_epochs": 1}),
        ("torch-etsformer-regularized-global", {"warmup_epochs": 1}),
        ("torch-etsformer-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-etsformer-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave70_global_etsformer_strategy_presets_smoke(

...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-wavenet-ema-global", {"warmup_epochs": 1}),
        ("torch-wavenet-swa-global", {"swa_start_epoch": 0}),
        ("torch-wavenet-sam-global", {"warmup_epochs": 1}),
        ("torch-wavenet-regularized-global", {"warmup_epochs": 1}),
        ("torch-wavenet-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-wavenet-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave76_global_wavenet_strategy_presets_smoke(key: str, overrides: dict[str, int]) -> None:

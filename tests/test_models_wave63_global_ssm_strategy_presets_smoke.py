...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-ssm-ema-global", {"warmup_epochs": 1}),
        ("torch-ssm-swa-global", {"swa_start_epoch": 0}),
        ("torch-ssm-sam-global", {"warmup_epochs": 1}),
        ("torch-ssm-regularized-global", {"warmup_epochs": 1}),
        ("torch-ssm-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-ssm-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave63_global_ssm_strategy_presets_smoke(key: str, overrides: dict[str, int]) -> None:

...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-inception-ema-global", {"warmup_epochs": 1}),
        ("torch-inception-swa-global", {"swa_start_epoch": 0}),
        ("torch-inception-sam-global", {"warmup_epochs": 1}),
        ("torch-inception-regularized-global", {"warmup_epochs": 1}),
        ("torch-inception-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-inception-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave78_global_inception_strategy_presets_smoke(

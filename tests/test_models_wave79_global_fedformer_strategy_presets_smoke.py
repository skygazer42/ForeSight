...
@pytest.mark.parametrize(
    ("key", "overrides"),
    (
        ("torch-fedformer-ema-global", {"warmup_epochs": 1}),
        ("torch-fedformer-swa-global", {"swa_start_epoch": 0}),
        ("torch-fedformer-sam-global", {"warmup_epochs": 1}),
        ("torch-fedformer-regularized-global", {"warmup_epochs": 1}),
        ("torch-fedformer-longhorizon-global", {"warmup_epochs": 1}),
        ("torch-fedformer-lookahead-global", {"warmup_epochs": 1}),
    ),
)
def test_wave79_global_fedformer_strategy_presets_smoke(
